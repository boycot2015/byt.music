...
const {
    ...
    versionPath: 'version.json', // version路径
    versionJsonPath: './public/version.json', // 项目日志输出路径
...
if (fs.existsSync(buildPath)) {
    fs.writeFileSync(`${buildPath}/${versionPath}`, fs.readFileSync(versionJsonPath))
}
// 程序执行结束
console.info('\x1B[32m%s\x1b[0m', '发布成功！')
