<template>
  <div class="comment pl-2">
    ...
    <el-scrollbar ref="scrollbarRef" height="calc(100vh - 85px)" class="pr-3" @end-reached="() => getComments({ page: commentList[1].page, limit: commentList[1].limit })">
...
import CommentTree from './Tree.vue'
