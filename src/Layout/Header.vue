    ...
    <template #content>
      <div class="flex items-center w-full md:w-[500px]">
        <div class="mr-3 flex items-center">
          ...
          <span class="text-large font-600" v-if="route.meta && (!route.meta.showSearch || !config.isMobile)">{{ getTitle() }}</span>
        </div>
...
const getTitle = () => {
  return route.query.title ? route.query.title + (route.query.area ? ' / ' + route.query.area : '') : route.meta.title
}
fetchData()
</script>
